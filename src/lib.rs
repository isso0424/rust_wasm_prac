...
macro_rules! measure_elapse_time {
    ($t:tt, $s:block) => {{
...
pub fn generate_mandelbrot_set(
    ...
    measure_elapse_time!("generate:wasm\telapsed:", {
...
pub fn draw_mandelbrot_set() {
    ...
    let mut result = measure_elapse_time!("generate:wasm\telapsed:", {
        logic::generate_mandelbrot_set(canvas_w, canvas_h, X_MIN, X_MAX, Y_MIN, Y_MAX, MAX_ITER)
    });
    measure_elapse_time!("draw:wasm\telapsed", {
